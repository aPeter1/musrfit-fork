...
sub NEW
{
    ...
    optionsConfigure= Qt::Action(this, "optionsConfigure");
    ...
    optionsConfigure->addTo( Options );
...
sub languageChange
{
    ...
    optionsConfigure->setText( trUtf8("Configure") );
    optionsConfigure->setMenuText( trUtf8("Configure") );
